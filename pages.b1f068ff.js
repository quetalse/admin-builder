...
},{"./../utils":"Feqj"}],"qFUg":[function(require,module,exports) {
'use strict';
...
},{"./../utils":"Feqj","./../core/settle":"Ztkp","./../helpers/cookies":"MLCl","./../helpers/buildURL":"phSU","../core/buildFullPath":"dm4E","./../helpers/parseHeaders":"Zn5P","./../helpers/isURLSameOrigin":"Rpqp","../core/createError":"NZT3","../defaults":"A14q","../cancel/Cancel":"qFUg"}],"g5IB":[function(require,module,exports) {
...
},{"./../utils":"Feqj","./transformData":"IAOH","../cancel/isCancel":"mXc0","../defaults":"A14q","../cancel/Cancel":"qFUg"}],"fBI1":[function(require,module,exports) {
'use strict';
...
},{"../env/data":"xOzr"}],"trUU":[function(require,module,exports) {
'use strict';
...
},{"./../utils":"Feqj","../helpers/buildURL":"phSU","./InterceptorManager":"xpeW","./dispatchRequest":"HALK","./mergeConfig":"fBI1","../helpers/validator":"bSmC"}],"VgQU":[function(require,module,exports) {
'use strict';
...
},{"./utils":"Feqj","./helpers/bind":"hRTX","./core/Axios":"trUU","./core/mergeConfig":"fBI1","./defaults":"A14q","./cancel/Cancel":"qFUg","./cancel/CancelToken":"VgQU","./cancel/isCancel":"mXc0","./env/data":"xOzr","./helpers/spread":"yisB","./helpers/isAxiosError":"FbOI"}],"O4Aa":[function(require,module,exports) {
module.exports = require('./lib/axios');
},{"./lib/axios":"Wzmt"}],"Y0fP":[function(require,module,exports) {
"use strict";
...
exports.select2API = exports.datatablesAPI = void 0;

var axios_1 = __importDefault(require("axios"));

var initialData = window;
var HOST_URL = initialData.HOST_URL;
...
var adminBuilderAPI = {
  ...
  getLoyalty: function getLoyalty(loyaltyId) {
  ...
  settings: {
    ...
    blocs: {
      ...
      edit: function edit(blocId, blocData) {
      ...
      delete: function _delete(blocId) {
    ...
    wg: {
      ...
      edit: function edit(wgId, wgData) {
        return instance.post("/api/wg/" + wgId, wgData);
      },
      // https://docs.google.com/document/d/186VtU8Yh56rADhMxOGcIrND8aqj1CNgUh6a4EbTJ7E4/edit#
      delete: function _delete(wgId) {
  ...
  classifiers: {
    loyalty: {
      ...
      edit: function edit(loyaltyId, loyaltyData) {
      ...
      delete: function _delete(loyaltyId) {
        return instance.post("/api/loyalty/" + loyaltyId + "/remove");
      },
      // https://docs.google.com/document/d/186VtU8Yh56rADhMxOGcIrND8aqj1CNgUh6a4EbTJ7E4/edit#
      get: function get(loyaltyId) {
        return instance.get("/api/loyalty/" + loyaltyId + "/read");
      }
    }
  },
  agreements: {
    twoSides: {
      ...
      add: function add(agreementsTwoSidesData) {
      ...
      edit: function edit(agreementsTwoSidesId, agreementsTwoSidesData) {
        agreementsTwoSidesData.append('type', 'twoside');
      ...
      delete: function _delete(agreementsTwoSidesId) {
...
function () {
  ...
  Select2App.templateSelect2 = function (repo) {
    if (repo.loading) return repo.text;

    if (repo.id !== '') {
      var preFunny = null; // console.log('repo', repo)
  ...
  Select2App.prototype.defineSelect2Elements = function (selectElements) {
    return selectElements.map(function (selectElement) {
      if (selectElement.ajax && selectElement.placeholder) {
        return $(selectElement.element).select2({
          ...
          ajax: {
            url: selectElement.disabled ? function (param) {
              var url = selectElement.ajax + $(document.getElementById("" + selectElement.dependencyFrom)).val();
              return url;
            } : selectElement.ajax,
            dataType: 'json',
            delay: 250,
        ...
        }).attr('data-ajaxById', "" + selectElement.ajaxById).attr('data-dependencyFor', "" + selectElement.dependencyFor).attr('data-dependencyUrl', "" + selectElement.dependencyUrl).attr('data-dependencyFrom', "" + selectElement.dependencyFrom);
      } else {
        return $(selectElement.element).select2();
      }
    });
...
exports.Select2App = Select2App;
},{}],"S0VA":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.FileUploaderApp = void 0;

var FileUploaderApp =
/** @class */
function () {
  function FileUploaderApp(_a) {
    var _this = this;

    var fileUploaderUrl = _a.fileUploaderUrl,
        inputFileElement = _a.inputFileElement;

    this.preloadFileUploader = function () {//@ts-ignore
    ...
    this.initThumbnails = function () {
      return {
        box: '<div class="fileuploader-items">' + '<ul class="fileuploader-items-list">' + '<li class="fileuploader-input"><button type="button" class="fileuploader-input-inner"><i class="fileuploader-icon-main"></i> <span>${captions.feedback}</span></button></li>' + '</ul>' + '</div>',
        item: '<li class="fileuploader-item">' + '<div class="fileuploader-item-inner">' + '<div class="actions-holder">' + '<button type="button" class="fileuploader-action fileuploader-action-sort is-hidden" title="${captions.sort}"><i class="fileuploader-icon-sort"></i></button>' + '<button type="button" class="fileuploader-action fileuploader-action-settings is-hidden" title="${captions.edit}"><i class="fileuploader-icon-settings"></i></button>' + '<button type="button" class="fileuploader-action fileuploader-action-remove" title="${captions.remove}"><i class="fileuploader-icon-remove"></i></button>' + '<div class="gallery-item-dropdown">' + '<a class="fileuploader-action-popup">${captions.setting_edit}</a>' + '<a class="gallery-action-rename">${captions.setting_rename}</a>' + '<a class="gallery-action-asmain">${captions.setting_asMain}</a>' + '</div>' + '</div>' + '<div class="thumbnail-holder">' + '${image}' + '<span class="fileuploader-action-popup"></span>' + '<div class="progress-holder"><span></span>${progressBar}</div>' + '</div>' + '<div class="content-holder"><h5 title="${name}">${name}</h5><span>${size2}</span></div>' + '<div class="type-holder">${icon}</div>' + '</div>' + '</li>',
        item2: '<li class="fileuploader-item file-main-${data.isMain}">' + '<div class="fileuploader-item-inner">' + '<div class="actions-holder">' + '<button type="button" class="fileuploader-action fileuploader-action-sort" title="${captions.sort}"><i class="fileuploader-icon-sort"></i></button>' + '<button type="button" class="fileuploader-action fileuploader-action-settings" title="${captions.edit}"><i class="fileuploader-icon-settings"></i></button>' + '<button type="button" class="fileuploader-action fileuploader-action-remove" title="${captions.remove}"><i class="fileuploader-icon-remove"></i></button>' + '<div class="gallery-item-dropdown">' + '<a href="${data.url}" target="_blank">${captions.setting_open}</a>' + '<a href="${data.url}" download>${captions.setting_download}</a>' + '<a class="fileuploader-action-popup">${captions.setting_edit}</a>' + '<a class="gallery-action-rename">${captions.setting_rename}</a>' + '<a class="gallery-action-asmain">${captions.setting_asMain}</a>' + '</div>' + '</div>' + '<div class="thumbnail-holder">' + '${image}' + '<span class="fileuploader-action-popup"></span>' + '</div>' + '<div class="content-holder"><h5 title="${name}">${name}</h5><span>${size2}</span></div>' + '<div class="type-holder">${icon}</div>' + '</div>' + '</li>',
        itemPrepend: true,
        ...
        onItemShow: function onItemShow(item, listEl, parentEl, newInputEl, inputEl) {
          var api = $.fileuploader.getInstance(inputEl),
              ...
              $progressBar = item.html.find('.progress-holder'); // put input first in the list

          $plusInput.prependTo(listEl); // color the icon and the progressbar with the format color
        ...
        onImageLoaded: function onImageLoaded(item, listEl, parentEl, newInputEl, inputEl) {
          var api = $.fileuploader.getInstance(inputEl); // add icon

          item.image.find('.fileuploader-item-icon i').html('').addClass('fileuploader-icon-' + (['image', 'video', 'audio'].indexOf(item.format) > -1 ? item.format : 'file')); // check the image size
    ...
    this.initUpload = function () {
      return {
        ...
        start: true,
        synchron: true,
        beforeSend: function beforeSend(item) {
          // check the image size first (onImageLoaded)
          if (item.format == 'image' && !item.reader.done) return false; // add editor to upload data after editing
        ...
        onSuccess: function onSuccess(result, item) {
          ...
          if (data.isSuccess && data.files.length) {
            if (!item.data.listProps) item.data.listProps = {};
        ...
        onError: function onError(item) {
          item.html.find('.progress-holder, .fileuploader-action-popup, .fileuploader-item-image').hide(); // add retry button

          item.upload.status != 'cancelled' && !item.imU && !item.html.find('.fileuploader-action-retry').length ? item.html.find('.actions-holder').prepend('<button type="button" class="fileuploader-action fileuploader-action-retry" title="Retry"><i class="fileuploader-icon-retry"></i></button>') : null;
        },
    ...
    this.initEditor = function () {
      return {
        ...
        onSave: function onSave(dataURL, item) {
          // if no editor
          if (!item.editor || !item.reader.width) return; // if uploaded
          // resend upload

          if (item.upload && item.upload.resend) item.upload.resend(); // if preloaded
          // send request
      ...
      return {
        onSort: function onSort(list, listEl, parentEl, newInputEl, inputEl) {
          var api = $.fileuploader.getInstance(inputEl),
              ...
              list = []; // prepare the sorted list

          api.getFiles().forEach(function (item) {
            if (item.data.listProps) list.push({
              name: item.name,
              id: item.data.listProps.id,
              index: item.index
            });
    ...
    this.init = function (listEl, parentEl, newInputEl, inputEl) {
      var api = $.fileuploader.getInstance(inputEl),
          $plusInput = listEl.find('.fileuploader-input'); // bind input click

      $plusInput.on('click', function () {
        api.open();
      }); // set drop container

      api.getOptions().dragDrop.container = $plusInput; // bind dropdown buttons

      $('body').on('click', function (e) {
        var $target = $(e.target),
            $item = $target.closest('.fileuploader-item'),
            item = api.findFile($item); // toggle dropdown
        ...
        if ($target.is('.gallery-action-rename')) {
          ...
          if (x && item.data.listProps) {
            $.post(_this.fileUploaderUrl + "?type=rename", {
              name: item.name,
              id: item.data.listProps.id,
              title: x
            }, function (result) {
              try {
                var j = JSON.parse(result); // update the file name and url
                ...
                if (j.title) {
                  ...
                  if (item.popup.html) item.popup.html.find('h5:eq(0)').text(item.name);
                  if (j.url) item.data.url = j.url;
                  if (item.appended && j.file) item.file = j.file;
                  api.updateFileList();
                }
              } catch (e) {
        ...
        if ($target.is('.gallery-action-asmain') && item.data.listProps) {
          $.post(_this.fileUploaderUrl + "?type=asmain", {
            name: item.name,
            id: item.data.listProps.id
          }, function () {
    ...
    this.initOnRemove = function (item) {// send request
    ...
    this.initFileUploader = function () {
      var $fileUploader = $(_this.inputFileElement).fileuploader({
        limit: 100,
        fileMaxSize: 20,
        ...
        theme: 'gallery',
        enableApi: true,
        thumbnails: _this.initThumbnails(),
        dragDrop: {
          container: '.fileuploader-theme-gallery .fileuploader-input'
        },
        upload: _this.initUpload(),
        // editor: this.initEditor(),
        // sorter: this.initSorter(),
        afterRender: _this.init,
        onRemove: _this.initOnRemove,
  ...
  return FileUploaderApp;
}();

exports.FileUploaderApp = FileUploaderApp;
...
},{}],"vnCR":[function(require,module,exports) {
"use strict";
...
var customSwal = sweetalert2_1.default.mixin({
  customClass: {
...
var sweetAlert = {
  ...
  confirm: function confirm(textHtml) {
    return customSwal.fire({
      title: 'Are u sure?',
      html: textHtml,
      icon: 'warning',
...
},{"sweetalert2":"Y8u2"}],"yGAG":[function(require,module,exports) {
"use strict";
...
exports.FormApp = void 0;

var Select2App_1 = require("./Select2App");

var FileUploaderApp_1 = require("./FileUploaderApp");
...
function (_super) {
  ...
  function FormApp(_a) {
    var select2Data = _a.select2Data,
        // data for select2App Class
    fileUploaderData = _a.fileUploaderData,
        select2Request = _a.select2Request,
        formElement = _a.formElement,
        submitBtnForm = _a.submitBtnForm,
        formFields = _a.formFields;

    var _this = _super.call(this, select2Data) || this;

    _this.dropValidateForm = function () {
      _this.formValidator.resetForm();

      _this.select2FormElements.forEach(function (select2FormElement) {
        var select2Name = select2FormElement.attr('name');
        var select2 = _this.formValidator.elements[select2Name];
    ...
    _this.dropForm = function () {
      _this.formValidator.form.reset();

      _this.formValidator.resetForm();

      _this.select2FormElements.forEach(function (select2FormElement) {
        var select2Name = select2FormElement.attr('name');
        var select2 = _this.formValidator.elements[select2Name]; //@ts-ignore
        ...
        if ($(select2FormElement).data('dependencyfrom') !== "undefined") {
          //@ts-ignore
          $(select2FormElement).select2('enable', false); // $(select2FormElement).empty().trigger('change')
        }
      }); // let select2 = this.formValidator.elements.loyalty;
    ...
    _this.initDependencySelect2 = function () {
      _this.select2FormElements.forEach(function (select2) {
        var dependencyFor = select2.data('dependencyfor');

        if (dependencyFor !== 'undefined') {
          select2.on('select2:select', function (e) {
            var targetSelect2 = document.getElementById("" + dependencyFor);

            if (!e.params.hasOwnProperty('synthetic')) {
              $(targetSelect2).empty().trigger('change');
            } //@ts-ignore


            $(targetSelect2).select2('enable');
          });
        }
      });
    };

    if (fileUploaderData) _this.fileUploaderData = new FileUploaderApp_1.FileUploaderApp(fileUploaderData);
    _this.formElement = formElement;
    _this.select2Request = select2Request;
    _this.submitBtnForm = $(submitBtnForm);
    _this.formValidator = formFields ? _this.validationForm(formFields) : null;
    return _this;
  }

  FormApp.prototype.checkEmptyForm = function () {
    var check = false;

    if (this.formElement.elements) {
      Array.from(this.formElement.elements).forEach(function (element) {
  ...
  FormApp.prototype.validationForm = function (formFields) {
    var validatorFields = {};
        ...
        validators: {
          ...
          callback: {
            ...
            callback: function callback(input) {
              ...
              var elemType = elem.type; // console.log('elem', elem)
              ...
              if (value) {
                ...
                if (elemTag === "SELECT") {
                  var selection = $(elem).data('select2').$selection.get(0);
                  selection.classList.add('own-validate-invalid');
                  return false;
                } else if (elemType === 'file') {} else {
    ...
    var submitBtn = this.submitBtnForm.get(0),
        formElement = this.formElement;
    var validator = window.FormValidation.formValidation(formElement, {
    ...
    this.select2FormElements.forEach(function (select2) {
      select2.on('select2:select', function (e) {
        var selection = $(e.target).data('select2').$selection.get(0);
        var name = select2.attr('name');
        validator.revalidateField(name).then(function (status) {
          if (status === "Valid") {
  ...
  FormApp.prototype.getFormData = function () {
    return __awaiter(this, void 0, Promise, function () {
      var allFormResult, flagFormResult;
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            allFormResult = _a.sent();
            return [4
            /*yield*/
            , this.formValidator.validate('flag')];

          case 2:
            flagFormResult = _a.sent();
  ...
  FormApp.prototype.fillForm = function (recordId) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
                ...
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      return [4
                      /*yield*/
                      , this.crud.get(recordId)];

                    case 1:
                      responseData = _a.sent();
                      recordData = responseData.data; // let formElement = document.getElementById('country-form') as HTMLFormElement;
                      ...
                      if (this.formElement) {
                        Array.from(this.formElement.elements).forEach(function (element) {
                          ...
                          if (elemType === 'text') {
                            element.value = recordData[elemName];
                          } else if (elemType === 'textarea') {
                            element.value = recordData[elemName];
                          } else if (elemType === 'file') {} else if (elemType === 'color') {
                            element.value = recordData[elemName];
                          } else if (elemTag === 'SELECT') {
                            var $select2_1 = $(element); // let $select2 = $('#countries-select2');

                            var select2Id = recordData[elemName]; // console.log('se', this)
                            ...
                            var requestRoute = $(element).data('ajaxbyid'); // console.log('`${requestRoute}${recordId}`', `${requestRoute}${recordId}`)

                            var id = recordData[elemName]; // console.log('`${requestRoute}${recordId}`', `${requestRoute}${id}`)
                            // @ts-ignore

                            _this.select2Request("" + requestRoute + id).then(function (_a) {
                              var data = _a.data;
                              var isMultiple = $select2_1.attr('multiple') === 'multiple'; // $select2
                              // @ts-ignore
                              ...
                              if (isMultiple) {
                                data.forEach(function (item) {
                                  // @ts-ignore
                                  $select2_1.select2("trigger", "select", {
                                    data: item,
                                    synthetic: true
                                  });
                                });
                              ...
                              return sweetAlert_1.default.error(e);
                            }); //
          ...
          case 3:
            e_1 = _a.sent();
            sweetAlert_1.default.error(e_1).then(function (result) {
              /* Read more about isConfirmed, isDenied below */
              if (result.isConfirmed) {
                _this.fillForm(recordId);
              } else if (result.isDenied) {
                sweetAlert_1.default.close();
                e_1.target.disabled = false;
              }
            });
            throw new Error(e_1);
  ...
  return FormApp;
}(Select2App_1.Select2App);

exports.FormApp = FormApp;
},{"./Select2App":"mEZJ","./FileUploaderApp":"S0VA","../sweetAlert":"vnCR"}],"FzO0":[function(require,module,exports) {
"use strict";
...
var FormApp_1 = require("../common/Classes/FormApp");

$(function () {
  var indexPage = new FormApp_1.FormApp({
    select2Request: api_1.select2API.getData,
    select2Data: {
      selectElements: [],
      selectFormElements: [{
        element: document.getElementById('bloc-select2'),
        ajax: api_1.select2API.example1.items1.all,
        ajaxById: api_1.select2API.example1.items1.byId,
        multiple: true,
        placeholder: "select items..."
      }]
    },
    formElement: document.getElementById('example-form'),
    submitBtnForm: document.getElementById('submit-form'),
    fileUploaderData: {
      fileUploaderUrl: "fileUploaderAPI.twosides",
      inputFileElement: document.querySelector('input.gallery_media')
    } // formFields: ['title', 'items_id[]'] // names

  });
  console.log('indexPage', indexPage); // ownPage.initDataTable().initModal();
  // window.ownPage = ownPage
  // $("#countryModal").trackChanges(); // запускаем совю функцию отслеживнаия касаний формы
});
},{"../common/api":"Y0fP","../common/Classes/FormApp":"yGAG"}]},{},["FzO0"], null)
//# sourceMappingURL=pages.b1f068ff.js.map
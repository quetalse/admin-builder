...
// }
//
// export type FileUploaderAppT = {
//     fileUploaderUrl: string
//     inputFileElement: HTMLElement,
// }
//
// export class FileUploaderApp {
//
//     fileUploaderUrl: string;
//     $fileUploader: JQuery;
//     inputFileElement: HTMLElement
//
//     constructor({fileUploaderUrl, inputFileElement}: FileUploaderAppT){
//         this.fileUploaderUrl = fileUploaderUrl;
...
//     preloadFileUploader = () => {
//         //@ts-ignore
//         return $.post(`${ this.fileUploaderUrl}?type=preload&model_type=Agreement`, null, function(result) {
...
//     initUpload = () => {
//         return {
//             url: `${this.fileUploaderUrl}?type=upload`,
//             data: null,
//             type: 'POST',
...
//
//                     $.post(`${this.fileUploaderUrl}`, {name: item.name, id: item.data.listProps.id, _editor: JSON.stringify(item.editor)}, function() {
//                         // update the image
...
//     }
//
//     init = (listEl, parentEl, newInputEl, inputEl) => {
//         var api = $.fileuploader.getInstance(inputEl),
//             $plusInput = listEl.find('.fileuploader-input');
//
//         // bind input click
...
//                     $.post(`${this.fileUploaderUrl}?type=rename`, {name: item.name, id: item.data.listProps.id, title: x}, function(result) {
//                         try {
...
//                 $.post(`${this.fileUploaderUrl}?type=asmain`, {name: item.name, id: item.data.listProps.id}, function() {
...
//         // send request
//         if (item.data.listProps)
//             $.post(`${this.fileUploaderUrl}?type=remove`, {
//                 name: item.name,
//                 id: item.data.listProps.id
//             });
//     },
...
//
//         let $fileUploader = (<any>$(this.inputFileElement)).fileuploader({
//             limit: 100,
//             fileMaxSize: 20,
//             // extensions: ['image/*', 'video/*', 'audio/*, docs/*'],
//             changeInput: ' ',
//             theme: 'gallery',
//             enableApi: true,
...
//             onRemove: this.initOnRemove,
//             captions: $.extend(true, {}, '', {
//                 feedback: 'Добавить файлы',

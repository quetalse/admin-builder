...
const dtSettings = {
    scrollX: true,
    ajax: {
        url: datatablesAPI.classifiers.loyalty,
        type: 'POST',
        data: {
...
$(function() {
    ...
    let ownPage = new DataTablesApp({
        ...
        crud: adminBuilderAPI.classifiers.loyalty,
        ...
        modalData: {
            modalElement: document.getElementById('loyaltyModal') as HTMLElement,
            ...
            formData: {
                ...
                formElement: document.getElementById('loyalty-form') as HTMLFormElement,
